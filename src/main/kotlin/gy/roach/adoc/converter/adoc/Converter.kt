...
class Converter {
    ...
    fun makeHtml(file: File): Converter {
           ...
           val attrs = Attributes.builder()
               ...
               .attribute("guy-flag", "&#127468;&#127486;")
               .attribute("panel-server", "https://docops.io/extension")
               .attribute("panel-webserver", "https://docops.io/extension")
               .dataUri(true)
               .copyCss(true)
               .noFooter(true)
               .attribute("tocbot")
    ...
    fun makePdf(): Converter {
        ...
        val attrs = Attributes.builder()
            ...
            .attribute("pdf-themesdir", "src/main/asciidoc/resources/themes")
